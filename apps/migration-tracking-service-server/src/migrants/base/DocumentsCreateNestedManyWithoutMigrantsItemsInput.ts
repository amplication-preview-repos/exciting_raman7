...
@InputType()
class DocumentsCreateNestedManyWithoutMigrantsItemsInput {
...
export { DocumentsCreateNestedManyWithoutMigrantsItemsInput as DocumentsCreateNestedManyWithoutMigrantsItemsInput };
